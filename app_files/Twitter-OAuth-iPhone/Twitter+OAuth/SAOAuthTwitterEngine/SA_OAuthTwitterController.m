...
//	if (![self credentialEntryRequiredWithTwitterEngine: engine]) return nil; //強制的に別アカウントで
...
+ (SA_OAuthTwitterController *) controllerToEnterCredentialsWithTwitterEngineAtAnotherAccount: (SA_OAuthTwitterEngine *) engine delegate: (id <SA_OAuthTwitterControllerDelegate>) delegate {
	return [SA_OAuthTwitterController controllerToEnterCredentialsWithTwitterEngineAtAnotherAccount: engine delegate: delegate forOrientation: UIInterfaceOrientationPortrait];
}
//▲awazu
